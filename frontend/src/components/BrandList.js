...
class BrandList extends Component {
  ...
  getItemData = async () => {
    try {
      const itemResponse = await fetch('http://127.0.0.1:8000/api/item/');
              ...
              {brand.image && (
                <img
                  ...
                  style={{
                    ...
                    transform: clickedBrandId === brand.id ? 'rotate(180deg)' : 'rotate(0deg)',
                    filter: clickedBrandId === brand.id ? 'invert(100%)' : 'invert(0%)',
                  }}
