...
const CVForm = () => {
  ...
  const handleButtonAction = () => {
    if (cvFile) {
      // If a file is selected, perform file upload logic
      console.log("File uploaded:", cvFile);

      // After file upload logic, show success popup
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Show the modal on successful upload
    ...
    <>
      ...
      <div className='row'>
        ...
        <div className='colp col-md-6'>
          <p>We have some excellent openings for aspiring individuals
             who think that they have got the potential
             and skills that can be combined to bombard the ongoing
             revolution in the food industry.</p>
        </div>
